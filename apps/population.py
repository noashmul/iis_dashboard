    ...
    html.H4(
        children=[html.H4(['בעמוד הנוכחי תוכלו לראות מגוון נתונים בנושא הדמוגרפיה של הדר'],
                          style={'text-align': 'right', 'text-transform': 'none', 'font-family': 'sans-serif',
                                 'letter-spacing': '0em'}, ),
                  html.H4([
                      'ניתן לבחור ולראות מפה המציגה את הערכים הנוכחיים של כמות האוכלוסיה הכללית בכל אזור סטטיסטי, וכן מפה המראה את השינויים מהחצי שנה הקודמת. בהמשך מוצגים גרפים אשר מציגים מידע נוסף על אוכלוסיה זו, וניתן לבחור להציג בהם מידע רק על אזור סטטיסטי מסוים. מוצגת למטה החלוקה של האוכלוסיה לנשים / גברים ולאחוז החרדים (עבור הדר כולה או עבור האזור הנבחר - במעבר על גרף העוגה ניתן לראות גם את הערכים עצמם ולא רק אחזוים). בנוסף, מוצג גרף אשר מראה את התפלגות הגילאים ואת השינוי בין התקופות השונות.']
                      , style={'text-align': 'right', 'text-transform': 'none', 'font-family': 'sans-serif',
